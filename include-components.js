  ...
  if (componentsToInclude.includes("nav")) {
    ...
    <nav style="background-color: #f9f5f0; border-bottom: 1px solid #e0d5c9; padding: 0.8rem 2rem; display: flex; align-items: center; box-shadow: 0 2px 10px rgba(107, 68, 35, 0.05);">
        ...
        <div style="display: flex; align-items: center; margin-left: auto; gap: 15px;">
            ...
            <a href="${pathToRoot}login.html" id="auth-button" class="auth-buttons" data-i18n="Iniciar Sesión" style="color: #6b4423; text-decoration: none; font-weight: 500; background-color: rgba(107, 68, 35, 0.08); padding: 8px 16px; border-radius: 20px; transition: all 0.3s ease;">Iniciar Sesión</a>
        ...
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}quienes-somos.html" data-i18n="Quiénes Somos" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Qui Som</a></li>
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}contacto.html" data-i18n="Contacto" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Contacte</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}politica_privacidad.html" data-i18n="Política de Privacidad" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Política de Privacitat</a></li>
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}terminos_condiciones.html" data-i18n="Términos y Condiciones" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Termes i Condicions</a></li>
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}politica_cookies.html" data-i18n="Política de Cookies" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Política de Cookies</a></li>
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}aviso_legal.html" data-i18n="Aviso Legal" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Avís Legal</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}Platos.html" data-i18n="Recetas" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Receptes</a></li>
                        <li style="margin-bottom: 0.6rem;"><a href="${pathToRoot}chefs.html" data-i18n="Chefs" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; display: block; padding: 3px 0; transition: all 0.3s ease;">Xefs</a></li>
                    </ul>
                </div>
...
function setupSearchFunctionality() {
  ...
  function getRecipeUrl(receta) {
    ...
    const urlMap = {
      "pollo-agridulce": `${pathToRoot}US6_GuardarRecetas/pollo-agridulce.html`,
      paella: `${pathToRoot}US6_GuardarRecetas/paella.html`,
