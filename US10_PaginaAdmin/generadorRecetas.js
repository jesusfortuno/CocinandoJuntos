...
function generarNombreArchivo(titulo) {
  ...
  function generarHTMLReceta(receta) {
    ...
    // Determinar la categoría para el breadcrumb
    let categoriaBreadcrumb = "Platos Principales"
      ...
      <main>
          <div class="breadcrumb">
              <a href="./../US1_PantallaInicio/index.html">Inicio</a> > <a
                  href="./../US1_PantallaInicio/${categoriaBreadcrumb.toLowerCase()}.html">${categoriaBreadcrumb}</a> > ${receta.titulo}
          </div>
              ...
              <div class="recipe-center-column">
                  <div class="recipe-info">
                      <div class="recipe-tags">
                          ...
                          <!-- Eliminamos la referencia a cultura para evitar errores -->
                      </div>
                      ...
                      <!-- Eliminamos la sección de descripción -->
                  </div>
              </div>
